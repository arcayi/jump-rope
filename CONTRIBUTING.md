...
Welcome to `sportai_skiprope` contributor's guide.
...
If you experience bugs or general issues with `sportai_skiprope`, please have a look
...
You can help improve `sportai_skiprope` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`sportai_skiprope` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `sportai_skiprope`'s files. While this mechanism can
...
```
conda create -n sportai_skiprope python=3 six virtualenv pytest pytest-cov
conda activate sportai_skiprope
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/sportai_skiprope.git
   cd sportai_skiprope
   ```
...
5. Install [pre-commit]:
   ...
   `sportai_skiprope` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/sportai_skiprope
[issue tracker]: https://github.com/<USERNAME>/sportai_skiprope/issues
